...
//sem uz len davat to co chces robit a posielat a prijimat so sndmsg a rcvmsg

//rcvMsg();
//if (incoming.str == "Hello")
//{outgoing.str = "World!";
//sndMsg();

//if (Serial.available()) {
//  outgoing.str = Serial.readString();
 //Serial.print("Sending:");
  //Serial.println(outgoing.str);
  //sndMsg();
 //}
   //sndMsg();
