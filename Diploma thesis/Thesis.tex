...
\title{Rozpoznávanie emocionálneho stavu používate¾a pomocou inteligentných 
riadiacich systémov}
\begin{document}
...
\vfill
{\bfseries\LARGE ROZPOZNÁVANIE EMOCIONÁLNEHO STAVU POUŽÍVATE¼A POMOCOU 
INTELIGENTNÝCH RIADIACICH SYSTÉMOV\par}
\vspace{1cm}
{\bfseries\Large Diplomová práca\par}
\par}
\vfill
\Large{
Študijný program: Aplikovaná informatika (magisterský II. St., denná  
forma)\par
Študijný odbor:  AI15m - Aplikovaná informatika\par
Školiace pracovisko: Katedra Matematiky\par
Školite¾: Mgr. Martin Magdin, PhD\par}
\vfill
\textbf{Nitra 2018}\hfill\textbf{Bc. Michal Kohútek}
\end{titlepage}
\onehalfspacing
\chapter*{Abstract}
\cfoot{}
...
\paragraph{} An example of three-dimensional models, the Lövheim cube of 
...
\begin{figure} [ht]
	...
	\centering
	\caption{Lövheim cube of emotion}
	\label{fig:}
\end{figure}
